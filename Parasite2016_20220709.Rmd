...
#my_palette <- colorRampPalette(c("firebrick4", "white", "#000066"))(n = 199)

# (optional) defines the color breaks manually for a "skewed" color transition
#col_breaks = c(seq(-10,0.000001,length=100),   
#               seq(0, length = 1),
#               seq(0.00001,10,length=100))  

#data <- read.csv('PIP_figure.csv', sep=';', header=T)
#rnames <- data[,1]                            # assign labels in column 1 to "rnames"
#mat_data <- as.matrix(data[,2:ncol(data)])  # transform column 2-5 into a matrix
...
heatmap.2(PIP,
          ...
          col=redblue(256),       # use on color palette defined earlier enable color transition at specified limits
